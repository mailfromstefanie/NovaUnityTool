...
## 1️⃣ Installatie
Volg eerst de [Installatiehandleiding](Docs/INSTALL.md) om de tool in Unity te installeren.
...
- [Gebruikershandleiding](Docs/USAGE.md)
- [Probleemoplossing](Docs/TROUBLESHOOTING.md)
- [Veelgestelde vragen](Docs/FAQ.md)
